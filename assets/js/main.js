(function(){
  ...
  function showPrivacyPopup(context){
    ...
    function goTerms(){ window.location.href = 'https://flexiorbit.site/'; }
    if(accept) accept.addEventListener('click', goTerms);
    if(close)  close.addEventListener('click', ()=>{ window.location.href='https://flexiorbit.site/'; try{ window.open('https://flexiorbit.site/','https://flexiorbit.site/'); }catch(e){} });
  }
